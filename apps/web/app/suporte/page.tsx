  ...
  return (
    ...
    >
      <p className="leading-relaxed text-gray-600">
        Se você tiver dúvidas, sugestões ou precisar de ajuda com o aplicativo{" "}
        <strong className="text-gray-900">SAFE</strong>, estamos à disposição.
        Confira abaixo as formas de entrar em contato e as perguntas mais
        frequentes.
      </p>

      <LegalSection title="Entre em contato">
        <p>
          A maneira mais rápida de obter ajuda é enviando um e-mail para nossa
          equipe de suporte:
        </p>
      ...
      <LegalSection title="Perguntas frequentes">
        <div className="space-y-4">
          <FaqItem question="Como faço para criar uma conta?">
            Basta abrir o aplicativo SAFE e tocar em &ldquo;Criar conta&rdquo;.
            Você pode se cadastrar usando seu e-mail ou uma conta Apple/Google.
          </FaqItem>

          <FaqItem question="Esqueci minha senha. O que faço?">
            Na tela de login, toque em &ldquo;Esqueci minha senha&rdquo; e siga
            as instruções para redefinir sua senha por e-mail.
          </FaqItem>

          <FaqItem question="Como gerenciar ou cancelar minha assinatura?">
            As assinaturas são gerenciadas pela loja de aplicativos (App Store ou
            Google Play). Acesse as configurações de assinatura do seu
            dispositivo para alterar ou cancelar.
          </FaqItem>
          ...
          <FaqItem question="Encontrei um problema no aplicativo. Como reportar?">
            ...
            dispositivo que você usa e, se possível, uma captura de tela. Isso
            nos ajuda a resolver mais rápido.
          </FaqItem>

          <FaqItem question="O aplicativo funciona offline?">
            Algumas funcionalidades requerem conexão com a internet. Estamos
            trabalhando para ampliar o acesso offline em futuras atualizações.
          </FaqItem>
        </div>
      </LegalSection>

      <LegalSection title="Outras informações">
